...
import br.com.ntconsultant.instant.cooperative.voting.dto.ErrorApiResponse;
import br.com.ntconsultant.instant.cooperative.voting.exceptions.HttpException;
...
public class AdviceControllerConfig {
    ...
    private ErrorApiResponse getErrorApiResponse(String message, String details){
